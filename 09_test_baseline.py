...
TEST_DIRS = {
    # Original control groups
    "Clean (Original)": './data/gtsrb/GTSRB/Training',
    "Noisy (Bad)":      './data/processed/Noise',
    "Blurred (Bad)":    './data/processed/Blur',
    "Foggy (Bad)":      './data/processed/Fog',
    
    # === New: Restored groups ===
    "Restored (Noise)": './data/restored/Noise',
    "Restored (Blur)":  './data/restored/Blur',
    "Restored (Fog)":   './data/restored/Fog'
}
# ===============================================
...
def evaluate_model(model, data_dir, name):
    ...
    # For speed or trend verification, we could take a subset, or run full amount
...
def main():
    ...
    print("\n" + "="*30)
    print("Final Test Report (Comprehensive)")
    print("="*30)
